  ...
  return (
    ...
    <div className="w-full flex justify-between items-center">
      <div className='w-1/2 pr-12'>
        ...
        <NavLink className="block flex justify-center items-center mt-4 text-base w-28 h-9 bg-gray-800 text-gray-50 rounded border border-gray-50 hover:bg-gray-50 hover:text-gray-800 transition" to={user ? "/tasks" : "/login"}>{user ? "Start" : "Login"}</NavLink>
      </div>
      <div className='w-1/2'>
